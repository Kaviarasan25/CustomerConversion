...
def main():
    ...
    if page == "ABOUT":
        st.title('Welcome to Guvi Care')
        st.write('**Creators:** Kaviarasan KG')
        st.write('**Email:** kaviarasangk5@gmail.com')
        st.write('**Github:** https://github.com/Kaviarasan25')
